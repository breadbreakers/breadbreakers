...
<section class="section">
    <div class="container">
        ...
        <div class="content">
            ...
            <p>
                All reports will be independently reviewed and investigated by the President.
            </p>
            <p>
                Whistleblowers are expected to report in good faith. All identities and shared concerns will remain confidential, unless disclosure is legally required to parties such as legal counsel, law enforcement, or investigators.
            </p>
            ...
            <ul>
                ...
                <li>Name(s) of individual(s) or organisation(s) involved</li>
                <li>Your relationship to the individual(s) or organisation(s)</li>
                <li>A detailed account of the incident (including date, time, location, methods, and behaviour)</li>
                <li>The duration the issue has been occurring</li>
                <li>Any physical evidence or relevant supporting information</li>
            </ul>
            <p>
