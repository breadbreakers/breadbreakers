...
<section class="section">
	<div class="container">
		...
		<div class="content">
			...
			<p>
				To ensure clarity, all donations are allocated to one of two funds. Donors are required to
			...
			<p>
				Bread Breakers (SG) is committed to full cooperation with Singapore's regulatory
				authorities. We are open to periodic audits and reviews of our systems and processes to
				ensure they align with the Code of Practice. We will liaise closely with the Commissioner of
				Charities (COC), the Registry of Societies (ROS), and other relevant bodies as required.
			</p>

			<h4 class="subtitle is-6 mt-5 has-text-weight-semibold">AML/CFT Policy</h4>
			<p>
				We have implemented an Anti-Money Laundering and Countering the Financing of Terrorism
				(AML/CFT) policy. Our measures include donor verification, transaction monitoring, and a
				strict policy against anonymous donations. For more details, please see our <a
					rel="noopener"
					target="_blank"
					class="link"
					href="/governance/aml-cft">full AML/CFT Policy</a
				>.
			</p>

			<h4 class="subtitle is-6 mt-5 has-text-weight-semibold">General Risk Disclosure</h4>
			<p>
				While we take extensive measures to secure our platform, all online activities carry
				inherent or residual risks. We encourage donors to be vigilant. Please read our <a
					class="link"
					target="_blank"
					rel="noopener"
					href="/governance/risk-disclosure">General Risk Disclosure Policy</a
			...
			<p>
				As we are not an Institution of a Public Character (IPC), donations are not tax-deductible
				under Singapore law.
			</p>

			<h4 class="subtitle is-6 mt-5 has-text-weight-semibold">Contact Us</h4>
			<p>
				If you have any questions about our policies or your donation, please do not hesitate to <a
					class="link"
