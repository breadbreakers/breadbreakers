...
<script>
  ...
  async function handleSubmit(event) {
    ...
    try {
      const response = await fetch("/api/ringfence/reject", {
        method: "POST",
        headers: {
...
<div class="section">
  <div class="container">
    <h2 class="subtitle is-4">Reject Ringfence Request</h2>
    ...
    {#if success}
      <div class="mt-4 notification is-success">Rejected Ringfence!</div>
    {:else if error}
